...
namespace IoneVectronConverter.Ione
{
    ...
    {   
        ...
        public async Task SendPlus(bool allItems)
        {
            ...
            var mainCategoryIoneRefId = await sendMainCategories(categoryListResponse);
        ...
        private static async Task<int> sendMainCategories(ItemCategoryListResponse categoryListResponse)
        {
        ...
        private async Task<ItemListResponse> GetAllItemsAsync()
        {
            throw new NotImplementedException();
        }

        private async Task<ItemLinkLayerListResponse> GetAllItemLinkLayersAsync()
        {
            throw new NotImplementedException();
        }
